  ...
  <div class="dashboard-container">
    ...
    <div class="container" :class="{ hContainer: tableData.length }">
      ...
      <el-table v-if="tableData.length" :data="tableData" stripe class="tableBox">
        ...
        <el-table-column v-if="[0, 2, 3, 4, 5, 6].includes(orderStatus)" key="storeName" prop="storeName" label="门店"
          min-width="90" />
        <el-table-column v-if="[0, 2, 3, 4, 5, 6].includes(orderStatus)" key="tableNo" prop="tableNo" label="桌号"
          min-width="70" />
        <el-table-column v-if="[0, 2, 3, 4, 5, 6].includes(orderStatus)" key="address" prop="address" label="就餐信息"
        ...
        <div class="order-middle">
          ...
          <div class="dish-info">
            ...
            <div class="dish-all-amount">
              <label>菜品小计</label>
              <span>￥{{ diaForm && diaForm.amount ? ((diaForm!.amount * 100) / 100).toFixed(2) : 0 }}</span>
            </div>
          </div>
        </div>
          ...
          <div class="amount-info">
            ...
            <div class="amount-list">
              <div class="dish-amount">
                ...
                <span class="amount-price">￥{{ diaForm && typeof diaForm.amount === 'number' ?
                  ((diaForm.amount * 100) / 100).toFixed(2) : 0 }}</span>
              </div>
              <div class="all-amount">
                <span class="amount-name">合计：</span>
                <span class="amount-price">￥{{ diaForm && diaForm.amount ?
